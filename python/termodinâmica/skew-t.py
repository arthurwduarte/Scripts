...
dados = pd.read_csv('/home/duarte/Documentos/mestrado-INPE/aulas/termodinamica/sound/maosondewnpnM1.b1.20150909.112800.custom.csv')

# Extrair os dados relevantes do DataFrame
p = dados['pres'].values * units.hPa
T = dados['tdry'].values * units.degC
Td = dados['dp'].values * units.degC
u = dados['u_wind'].values * units.meter / units.second  # Velocidade do vento em m/s
v = dados['v_wind'].values * units.degrees  # Direção do vento em graus
z = dados['alt'].values * units.m
wind_speed = dados['wspd'].values * units.knots
wind_dir = dados['deg'].values * units.degrees
u, v = mpcalc.wind_components(wind_speed, wind_dir)
height = dados['alt'].values * units.m
...
plt.figtext(0.45, 0.97, '09 DE SETEMBRO DE 2015 - 11Z',
